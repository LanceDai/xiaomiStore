...
<!-- start danpin -->
<div class="danpin center" style="height: 700px;">

    <div class="biaoti center">${typeName}</div>
    <div class="main center">
        <c:forEach items="${productMap}" var="pm">
            <div class="mingxing fl mb20"
                 style="border:2px solid #fff;width:230px;cursor:pointer;display: inline-block;margin: 10px 10px"
                 onmouseout="this.style.border='2px solid #fff'" onmousemove="this.style.border='2px solid red'">
                <div class="sub_mingxing">
                    <a href="/detail/${pm.key}" target="_self">
                        <img src="../static/image/thumb/${pm.key.replace(' ', '_').replace("\"", "")}.jpg" alt="">
                    </a>
                </div>
                <div class="pinpai"><a href="/detail/${pm.key}" target="_self">${pm.key}</a></div>
                <div class="youhui">5.16早10点开售</div>
                <div class="jiage">${pm.value}</div>
            </div>
        </c:forEach>
        <%--<div class="mingxing fl mb20" style="border:2px solid #fff;width:230px;cursor:pointer;"--%>
        <%--onmouseout="this.style.border='2px solid #fff'" onmousemove="this.style.border='2px solid red'">--%>
        <%--<div class="sub_mingxing"><a href="/detail/" target="_blank"><img src="../static/image/liebiao_xiaomi6.jpg"--%>
        <%--alt=""></a></div>--%>
        <%--<div class="pinpai"><a href="/detail/" target="_blank">小米6</a></div>--%>
        <%--<div class="youhui">5.16早10点开售</div>--%>
