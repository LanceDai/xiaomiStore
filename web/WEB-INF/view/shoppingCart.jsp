                    ...
                    <c:forEach items="${shoppingCartList}" var="scl" varStatus="status">
                        ...
                        <div class="content2 center item">
                            <div class="sub_content fl ">
                                <label>
                                    <input type="checkbox" data-index="${status.index}" value="quanxuan"
                                           class="quanxuan"
                                           id="choose"/>
                                </label>
                            </div>
                            ...
                            <div class="sub_content fl" style="width: 150px;">
                                <fmt:formatNumber type="number" value="${scl.price}" pattern="0.00"
                            ...
                            <div class="sub_content fl" id="sum_${status.index}"
                                 style="width: 100px;margin: 0 0 0 80px">
