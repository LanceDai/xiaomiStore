...
<div class="top center">
    <div class="logo center">
        <a href="index.jsp" target="_blank"><img src="../static/image/mistore_logo.png" alt=""></a>
    </div>
</div>
        ...
        <div class="login_center">
            ...
            <div class="login_main center">
                ...
                <div class="username">
                    ...
                    <div class="right fl"><img src="/captcha-image" id="kaptchaImage" title="看不清，点击换一张"
                                               onclick="changeVerifyCode()"></div>
                    <div class="clear"></div>
                </div>
            </div>
