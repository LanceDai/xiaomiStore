        ...
        <div class="lfnav fl">
            ...
            <div class="subddzx">
                <ul>
                    ...
                    <li><span class="subddzx-a"><a style="color:#ff6700;font-weight: bold;" href="javascript:;">我的关注</a></span></li>
                    ...
                    <c:forEach items="${resultList}" var="product">
                        <div class="mingxing fl mb20"
                            ...
                            <div class="sub_mingxing">
                                <a href="/detail/${product.productName}" target="_self">
                                    <img src="../static/image/thumb/${product.productName.replace(' ', '_').replace("\"", "")}.jpg" alt="">
                                </a>
                            </div>
                            <div class="pinpai"><a href="/detail/${product.productName}" target="_self">${product.productName}</a></div>
